...
return [
    ...
    */
    'generator'  => [
        ...
        'paths'         => [
            'models'       => 'Domain/'.env('DOMAIN').'/Entities',
            'repositories' => 'Infrastructure/'.env('DOMAIN').'/Repositories',
            'interfaces'   => 'Domain/'.env('DOMAIN').'/Contracts',
            'transformers' => 'Domain/'.env('DOMAIN').'/Transformers',
            'presenters'   => 'Domain/'.env('DOMAIN').'/Presenters',
            'validators'   => 'Domain/'.env('DOMAIN').'/Validators',
            'controllers'  => 'Http/Controllers/Api/V1',
            'provider'     => 'RepositoryServiceProvider',
            'criteria'     => 'Domain/'.env('DOMAIN').'/Criteria'
        ]
    ]
];
